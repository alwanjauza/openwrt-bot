...
export const getHuaweiSMS = async () => {
    try {
        ...
        console.log("3. Mengambil Token Baru...");
        ...
        console.error("Huawei Error:", error.message);
        return [];
    }
};